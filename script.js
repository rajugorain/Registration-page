...
add.onclick = function () {
    ...
    if (name != '' && email != '' && age != '' && addr != '' && birthday != '') {
        var values = []
        ...
        const description = `<p><strong>Name:</strong> ${name}<br><strong>Email:</strong> ${email}<br><strong>Age:</strong> ${age}<br><strong> Birthday: </strong>${birthday}<br><strong>Address: </strong> ${addr}<br><strong>Gender:</strong> ${document.querySelector('input[type="radio"]:checked').value}
